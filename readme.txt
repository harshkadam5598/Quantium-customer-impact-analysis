Customer Purchase Behavior & Sales Impact Analysis
...
Whether observed sales uplift is driven by frequency, basket size, or customer base

The directional impact of a business intervention using test–control logic
